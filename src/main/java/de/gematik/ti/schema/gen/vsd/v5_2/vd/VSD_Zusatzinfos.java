...
public class VSD_Zusatzinfos  {
    ...
    public VSD_ZusatzinfosGKV ZusatzinfosGKV;
    
    // default Constructor
    public VSD_Zusatzinfos() {
        
        this.ZusatzinfosGKV = new VSD_ZusatzinfosGKV();
        
    }
    
    // copy Constructor
    public VSD_Zusatzinfos(VSD_Zusatzinfos _VSD_Zusatzinfos) {
        
        this.ZusatzinfosGKV = _VSD_Zusatzinfos.ZusatzinfosGKV;
    }
    
    public static VSD_Zusatzinfos deserialize(Node node) {
        if (node == null) {
            return null;
        }
        Element element = (Element) node;
        
        VSD_Zusatzinfos _VSD_Zusatzinfos = new VSD_Zusatzinfos();
        
        NodeList nodeListZusatzinfosGKV = element.getElementsByTagNameNS(VSD_ZusatzinfosGKV.NAMESPACE_URI ,"ZusatzinfosGKV");
        Node nodeZusatzinfosGKV = nodeListZusatzinfosGKV.item(0);
        _VSD_Zusatzinfos.ZusatzinfosGKV = VSD_ZusatzinfosGKV.deserialize(nodeZusatzinfosGKV);
        
        return _VSD_Zusatzinfos;
    }
    
    public static List deserializeToList(List<Node> nodeList) {
        List result = new ArrayList<VSD_Zusatzinfos>();
    ...
    */
    public LinkedHashMap<String, Object> getElements() {
        ...
        elemArray.put("ZusatzinfosGKV", this.ZusatzinfosGKV);
