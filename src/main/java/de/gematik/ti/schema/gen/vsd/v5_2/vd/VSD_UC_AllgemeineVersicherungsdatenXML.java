...
public class VSD_UC_AllgemeineVersicherungsdatenXML  {
    ...
    // default Constructor
    public VSD_UC_AllgemeineVersicherungsdatenXML() {
    ...
    // copy Constructor
    public VSD_UC_AllgemeineVersicherungsdatenXML(VSD_UC_AllgemeineVersicherungsdatenXML _VSD_UC_AllgemeineVersicherungsdatenXML) {
        
        this.CDM_VERSION = _VSD_UC_AllgemeineVersicherungsdatenXML.CDM_VERSION;
        
        this.Versicherter = _VSD_UC_AllgemeineVersicherungsdatenXML.Versicherter;
    }
    
    public static VSD_UC_AllgemeineVersicherungsdatenXML deserialize(Node node) {
        if (node == null) {
            return null;
        }
        Element element = (Element) node;
        
        VSD_UC_AllgemeineVersicherungsdatenXML _VSD_UC_AllgemeineVersicherungsdatenXML = new VSD_UC_AllgemeineVersicherungsdatenXML();
        
        _VSD_UC_AllgemeineVersicherungsdatenXML.CDM_VERSION = element.getAttributeNode("CDM_VERSION") != null ? element.getAttributeNode("CDM_VERSION").getValue() : null;
        ...
        _VSD_UC_AllgemeineVersicherungsdatenXML.Versicherter = VSD_Versicherter.deserialize(nodeVersicherter);
        
        return _VSD_UC_AllgemeineVersicherungsdatenXML;
    }
    
    public static List deserializeToList(List<Node> nodeList) {
        List result = new ArrayList<VSD_UC_AllgemeineVersicherungsdatenXML>();
